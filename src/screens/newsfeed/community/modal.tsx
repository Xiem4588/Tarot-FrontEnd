                    ...
                    <NativeViewGestureHandler>
                      <View style={styles.borderBottom}>
                        <View
                          ...
                          <View
                            style={[styles.RowAlignItems, styles.marginLeft10]}>
                            <IconsMateria
                              name="clock-outline"
                              size={14}
                        ...
                        <Text>
                          Tại sao lá bài của tôi lại là lá ngược, ngược liệu có
                          mang đến nhiều điều xui xẻo không các chuyên gia ơi.
                          Mình có cách nào để vượt qua được nỗi sợ hãi này không
                          ?????
                        </Text>
                      </View>
