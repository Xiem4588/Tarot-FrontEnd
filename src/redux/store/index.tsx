...
import {PUBLIC_STORE_USER_DETAIL, PRIVATE_STORE_ACCOUNT_DATA} from './user/reducer';
...
const rootReducer = combineReducers({
  PRIVATE_STORE_ACCOUNT_DATA: PRIVATE_STORE_ACCOUNT_DATA,
  PUBLIC_STORE_USER_DETAIL: PUBLIC_STORE_USER_DETAIL,
});
...
const persistConfig = {
  ...
  whitelist: ['PRIVATE_STORE_ACCOUNT_DATA', 'PUBLIC_STORE_USER_DETAIL'], // Đặt các reducer bạn muốn lưu vào đây
};
